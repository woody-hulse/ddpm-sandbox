...
Usage:
    python -m tools.visualization.plot_rq_distributions
    python -m tools.visualization.plot_rq_distributions --n-samples 1000 --batch-size 16
    python -m tools.visualization.plot_rq_distributions --output-dir figures/rq_distributions --latent-dim 128
"""
...
from tools.analysis.compare_rqs import collect_rqs, RQ_UNITS
...
def main():
    ...
    parser.add_argument("--output-dir", type=str, default="figures/rq_distributions")
