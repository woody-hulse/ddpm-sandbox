...
Usage:
    python -m tools.visualization.synthetic_visualizer --channel_positions data/pmt_xy_42.h5
    python -m tools.visualization.synthetic_visualizer --channel_positions data/pmt_xy_42.h5 \\
        --output figures/synthetic/my_event.gif --seed 7 --n_electrons 15 --fps 24
"""
...
from tools.data.generate_synthetic import load_pmt_positions, H_EL_TO_PMT_CM, ELECTRON_SPREAD_CM
...
def generate_event_gif(
    pmt_positions: np.ndarray,
    output_path: str = "figures/synthetic/event_animation.gif",
    n_electrons: int = 14,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output",            type=str, default="figures/synthetic/event_animation.gif")
