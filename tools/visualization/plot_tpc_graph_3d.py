...
Usage:
    python -m tools.visualization.plot_tpc_graph_3d
    python -m tools.visualization.plot_tpc_graph_3d --num-z 1000 --radius 15 --z-hops 5
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output-dir", type=str, default="figures/tpc_graph_3d",
