...
Usage:
    python -m tools.visualization.view_events --view
    python -m tools.visualization.view_events --view --n 16 --seed 7
    python -m tools.visualization.view_events --compress 3 --model ae
    python -m tools.visualization.view_events --compress 3 --model diffae
...
def main():
    ...
    parser.add_argument("--output-dir", type=str, default="figures/event_views")
