...
Usage:
  python -m tools.analysis.compare_latent_sizes
  python -m tools.analysis.compare_latent_sizes --latent-dims 2 4 8 16 32 64 128
  python -m tools.analysis.compare_latent_sizes --skip-training
"""
import os
import sys
import glob
...
def main():
    ...
    parser.add_argument("--output-dir", type=str, default="figures/latent_comparison")
