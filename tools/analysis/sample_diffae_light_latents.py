...
Example:
    python -m tools.analysis.sample_diffae_light_latents --latent-dim 64 --n-samples 6 --seed 42
"""
import argparse
import os
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output-dir", type=str, default=None,
                        help="Directory for sampled waveforms and figures. Defaults to figures/plots/diffae_light_z*/latent_samples.")
