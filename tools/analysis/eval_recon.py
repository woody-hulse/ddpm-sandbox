...
Usage:
    python -m tools.analysis.eval_recon
    python -m tools.analysis.eval_recon --n-events 4096 --n-samples 8 --output-dir figures/eval_recon
    python -m tools.analysis.eval_recon --skip-graphae
    python -m tools.analysis.eval_recon --skip-diffae
"""
...
def main() -> None:
    ...
    parser.add_argument("--output-dir", type=str, default="figures/eval_recon")
